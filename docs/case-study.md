...
![The complete Relay workflow as built in n8n: the conversation pipeline plus the /resolve-ticket workflow (bottom left)](images/relay-workflow-full.png)
...
![Workflow Brain (section 3) and the Critic verification pass (section 5) on the n8n canvas](images/relay-brain-critic.png)
...
![Rate limiting and duplicate-detection guard rails](images/relay-rate-limiting.png)
...
![The ticket-resolution workflow, triggered from a Slack slash command](images/relay-ticket-resolution.png)
